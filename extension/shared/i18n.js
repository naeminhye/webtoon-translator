...
(function (global) {
  const STRINGS = {
    en: {
      ...
      'settings.ocr.paddlelocal_hw_fallback_btn':  'Use Tesseract.js instead',
      'settings.ocr.paddlelocal_hw_fallback_done': '✓ Switched to Tesseract.js',
      ...
      'settings.tr.perm_btn':               'Allow access to {host}',
      'settings.tr.perm_hint':              'Chrome asks for your consent before the extension may contact this provider — a one-time prompt per provider.',
    ...
    vi: {
      ...
      'settings.ocr.paddlelocal_hw_fallback_btn':  'Dùng Tesseract.js ngay',
      'settings.ocr.paddlelocal_hw_fallback_done': '✓ Đã chuyển sang Tesseract.js',
      ...
      'settings.tr.perm_btn':               'Cho phép truy cập {host}',
      'settings.tr.perm_hint':              'Chrome sẽ hỏi ý bạn trước khi tiện ích được phép kết nối tới provider này — chỉ hỏi một lần cho mỗi provider.',
