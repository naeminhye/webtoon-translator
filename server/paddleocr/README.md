...
Requires Python 3.9–3.12. (Downloaded the files individually from the
extension popup instead of cloning this repo? Save all four into one folder
and skip the `cd server/paddleocr` step below — run the rest from that
folder.)
...
<details><summary><b>Windows (PowerShell / cmd)</b></summary>
